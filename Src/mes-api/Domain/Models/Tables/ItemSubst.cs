...
[PrimaryKey("OrigItemId", "AltNo")]
[Table("item_subst")]
[Index("OrigItemId", "ItemId", Name = "IX_item_subst", IsUnique = true)]
public partial class ItemSubst
{
    [Key]
    [Column("orig_item_id")]
    [StringLength(40)]
    public string OrigItemId { get; set; } = null!;
    ...
    [InverseProperty("ItemSubstDefRejectEnts")]
    public virtual StorageExec? DefRejectEnt { get; set; }

    [ForeignKey("DefStorageEntId")]
    [InverseProperty("ItemSubstDefStorageEnts")]
